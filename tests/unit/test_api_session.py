...
class TestApiSession:
    ...
    def test_session_instance(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_content_type_header(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_accept_header(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_required_headers_exist(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_header_types(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_headers_object_exists(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_cookies_object_exists(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_adapters_exist(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_prepare_request(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_headers_in_prepared_request(self, api_session: MagicMock) -> None:
        request = requests.Request("GET", "https://dummyjson.com/users")
    ...
    @pytest.mark.positive
    def test_add_custom_header(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_add_cookie(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_verify_attribute(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_cert_attribute(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_auth_attribute(self, api_session: MagicMock) -> None:
    ...
    @pytest.mark.positive
    def test_proxies_attribute(self, api_session: MagicMock) -> None:
