...
class TestDeleteComments:
    ...
    def test_delete_comment_status_code(self, client: ApiClient) -> None:
    ...
    @pytest.mark.positive
    def test_deleted_comment_has_id(self, client: ApiClient) -> None:
        response = self._delete_comment(client, 1)
    ...
    @pytest.mark.positive
    def test_deleted_body_type(self, client: ApiClient) -> None:
        response = self._delete_comment(client, 1)
    ...
    @pytest.mark.positive
    def test_deleted_post_id_type(self, client: ApiClient) -> None:
        response = self._delete_comment(client, 1)
    ...
    @pytest.mark.positive
    def test_deleted_likes_type(self, client: ApiClient) -> None:
        response = self._delete_comment(client, 1)
    ...
    @pytest.mark.positive
    def test_deleted_user_type(self, client: ApiClient) -> None:
        response = self._delete_comment(client, 1)
    ...
    @pytest.mark.positive
    def test_deleted_user_fields(self, client: ApiClient) -> None:
        response = self._delete_comment(client, 1)
    ...
    @pytest.mark.positive
    def test_delete_various_comments(self, client: ApiClient, comment_id: int) -> None:
    ...
    @pytest.mark.negative
    def test_unknown_comment_id(self, client: ApiClient) -> None:
    ...
    @pytest.mark.positive
    def test_delete_multiple_comments(self, client: ApiClient, comment_id: int) -> None:
        response = self._delete_comment(client, comment_id)
    ...
    @pytest.mark.smoke
    @pytest.mark.positive
    def test_delete_comment_step_by_step(self, client: ApiClient) -> None:
