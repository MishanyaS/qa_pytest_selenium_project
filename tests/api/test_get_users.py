...
class TestGetUsers:
    ...
    def test_get_users_status_code(self, client: ApiClient) -> None:
    ...
    @pytest.mark.positive
    def test_users_key_exists(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    @pytest.mark.positive
    def test_users_is_list(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    @pytest.mark.smoke
    @pytest.mark.positive
    def test_users_is_not_empty(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    @pytest.mark.schema
    def test_first_user_schema(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    @pytest.mark.positive
    def test_first_user_has_id(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    @pytest.mark.positive
    def test_first_user_has_first_name(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    @pytest.mark.smoke
    @pytest.mark.positive
    def test_get_single_user_status_code(self, client: ApiClient) -> None:
    ...
    @pytest.mark.schema
    def test_single_user_schema(self, client: ApiClient) -> None:
        response = self._get_user(client, 1)
    ...
    @pytest.mark.positive
    def test_user_id_matches(self, client: ApiClient) -> None:
        response = self._get_user(client, 1)
    ...
    def test_unique_ids(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    def test_first_names_not_empty(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    def test_last_names_not_empty(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    @pytest.mark.positive
    def test_age_positive(self, client: ApiClient) -> None:
        response = self._get_users(client)
    ...
    @pytest.mark.positive
    def test_multiple_users(self, client: ApiClient, user_id: int) -> None:
