...
class InteractionsPage(BasePage):
    SELECTABLE_SECTION = (By.XPATH, "//span[text()='Selectable']")

    SORTABLE_SECTION = (By.XPATH, "//span[text()='Sortable']")

    RESIZABLE_SECTION = (By.XPATH, "//span[text()='Resizable']")

    DROPPABLE_SECTION = (By.XPATH, "//span[text()='Droppable']")

    DRAGGABLE_SECTION = (By.XPATH, "//span[text()='Dragabble']")

    SELECTABLE_ITEM_1 = (By.CSS_SELECTOR, "#selectable li:nth-child(1)")

    SELECTABLE_ITEM_2 = (By.CSS_SELECTOR, "#selectable li:nth-child(2)")

    SELECTABLE_ITEM_3 = (By.CSS_SELECTOR, "#selectable li:nth-child(3)")

    SELECTABLE_ITEM_4 = (By.CSS_SELECTOR, "#selectable li:nth-child(4)")

    SELECTABLE_ITEM_5 = (By.CSS_SELECTOR, "#selectable li:nth-child(5)")

    SELECTABLE_ITEMS = (By.CSS_SELECTOR, "#selectable li")

    SELECTABLE_ITEM_ACTIVE = (By.CSS_SELECTOR, "#selectable li.ui-selected")

    SORTABLE_ITEMS = (By.CSS_SELECTOR, "#sortable li")
    ...
    RESIZABLE_HANDLE = (By.CSS_SELECTOR, "#resizable .ui-resizable-se")
    ...
    def selected_items(self) -> list[str]:
        return [item.text for item in self.find_all(self.SELECTABLE_ITEM_ACTIVE)]
    ...
    def drag_sortable_item(self, source_index: int, target_index: int) -> None:
        source = (By.CSS_SELECTOR, f"#sortable li:nth-child({source_index})")

        target = (By.CSS_SELECTOR, f"#sortable li:nth-child({target_index})")

        self.drag_and_drop(source, target)

    def drag_sortable_item_by_locator(
